...
<head>
    ...
    <title>@ViewBag.Title - WebClientPrint 4.0 for ASP.NET</title>
    ...
    <div class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a href="//www.neodynamic.com/products/printing/raw-data/aspnet-mvc/download/" target="_blank" class="navbar-brand">WebClientPrint <span class="round white">4.0</span> for ASP.NET</a>
            </div>
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li>@Html.ActionLink("Home", "Index", "Home")</li>
                    <li>@Html.ActionLink("Samples", "Samples", "Home")</li>
                    <li>@Html.ActionLink("Printers", "PrintersInfo", "Home")</li>
                    <li>@Html.ActionLink("Print Files", "Index", "DemoPrintFile")</li>
                    <li>@Html.ActionLink("Print PDF", "Index", "DemoPrintFilePDF")</li>
                    <li>@Html.ActionLink("Print RAW Commands", "Index", "DemoPrintCommands")</li>
                    <li><a href="//www.neodynamic.com/products/printing/raw-data/aspnet-mvc/articles" target="_blank">Articles</a></li>
