@Code
    ViewData("Title") = "Printing Samples"
End Code
...
<table class="table table-bordered">
    <tr>
        <td><a href="@Url.Action("Index", "DemoPrintCommands")" class="btn btn-large btn-info">Print Raw Commands</a></td>
    ...
    <tr>
        <td><a href="@Url.Action("Index", "DemoPrintFile")" class="btn btn-large btn-info">Print Files</a></td>
    ...
    <tr>
        <td><a href="@Url.Action("Index", "DemoPrintFilePDF")" class="btn btn-large btn-info">Advanced PDF Printing</a></td>
    ...
    <tr>
        <td><a href="@Url.Action("PrintersInfo", "Home")" class="btn btn-large btn-info">Printers Info</a></td>
