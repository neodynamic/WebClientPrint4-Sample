<%@ Page Title="Printers Info" Language="VB" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderScripts" runat="Server">
    ...
    <%=Neodynamic.SDK.Web.WebClientPrint.CreateScript(HttpContext.Current.Request.Url.Scheme & "://" & HttpContext.Current.Request.Url.Host & ":" & HttpContext.Current.Request.Url.Port & "/WebClientPrintAPI.ashx", "", HttpContext.Current.Session.SessionID)%>
</asp:Content>
